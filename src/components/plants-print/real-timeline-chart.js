...
export const realTimeLineChart = function() {
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            var xMin = min(data, c => min(c.values, d => d.time));
            var xMax = new Date(
                new Date(
            ...
            g.selectAll("g .brush").call(brushing);
            ...
            function tick() {
                ...
                if (x1.length > 0) {
                    ...
                    select(this)
                        .attr("d", d => area1(d.values))
                        .attr("transform", null);
                    var xMinLess = new Date(new Date(x1save[0]).getTime() - duration);
                    active(this).attr("transform", "translate(" + x(xMinLess) + "," + y1save[0] + ")");
                    //.transition()
                    //on("start", tick);
