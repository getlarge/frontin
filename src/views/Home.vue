  ...
  <b-container id="hello" fluid>
    <b-row align-h="center">
      <b-col cols="12" sm="8" md="7" lg="6" xl="5">
        <svg id="guyName" pointer-events="all" viewBox="0 0 500 100" preserveAspectRatio="xMinYMin meet" />
      </b-col>
    </b-row>
    <hr class="my-4" />
    <b-row align-h="center">
      <b-col cols="10" sm="10" md="8" lg="7" xl="6">
        <p class="introduction">
          This portfolio shows a selection of my work. Each project on this site is done by myself, from design to
          engineering and the source code can be found
          <a href="https://github.com/getlarge/frontin" target="_blank">here</a>. I hope you'll have a good time passing
          by.
        </p>
      </b-col>
    </b-row>
    <b-row v-if="!contactCard" align-h="center">
      ...
      <b-col cols="6" sm="4" lg="3">
        <a class="doors" accesskey="C" title="Contact" @click="contactCard = !contactCard">
          <img
            :src="letterIcon"
            class="signs"
            alt="hi icon"
    ...
    <b-row v-else-if="contactCard && !available && frontCard !== null && backCard !== null" align-h="center">
...
export default {
  ...
  computed: {
    ...
    frontCard() {
      return {
        title: "Hey, i'm ...",
        text1: `<img class='square' src=${this.$store.state.style.pictures.rectangle}>
          <div>
            <img class='trombi' src=${this.notAvailableIcon}></img>
            <p class='text'></br>...on a mission, but you can send me your request anyway!</p>
          </div>`,
        text2: `<img class='square' src=${this.$store.state.style.pictures.rectangle}>
          <div>
            <img class='trombi' src=${this.availableIcon}></img>
            <p class='text'>Your project requires UI/UX design, frontend / backend development, or embedded system prototyping ?</br>Why not talking about it now.</p>
          </div>`,
      };
    },
    backCard() {
      return {
        title: 'contact',
        text: `<img class='square' src=${this.$store.state.style.pictures.rectangleFlipped}>
        <div>
          <img class='trombi' style='opacity:0.8;' src=${this.guyIcon}></img>
          <p class='text'>Edouard Maleix
            </br>
            <a href=mailto:ed@${this.$store.state.domain}>ed@${this.$store.state.domain}</a>
            </br>
            <a href=tel:${this.$store.state.tel}>${this.$store.state.tel}</a>
            </br>Vienna
            </br>References on request
          </p>
        </div>`,
      };
    },
